# Copied from https://github.com/Sunan-zhao/LESnets/blob/main/models/neural_operator.py
...
class FNO3d(nn.Module):
    ...
    def __init__(
        ...
        # Stack of fourier integeral operators 
        # Why does each FNO block have different modes
